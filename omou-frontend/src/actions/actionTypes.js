...
export const FETCH_TEACHER_AVAILABILITY_SUCCESSFUL = "FETCH_TEACHER_AVAILABILITY_SUCCESSFUL";
export const FETCH_TEACHER_AVAILABILITY_FAILED = "FETCH_TEACHER_AVAILABILITY_FAILED";
