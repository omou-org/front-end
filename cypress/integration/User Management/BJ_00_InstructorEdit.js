...
//             ({
//                 original_instructor_data,
//                 updated_instructor_data,
...
//                                     ) {
//                                         expect(
//                                             updated_instructor_data[key] ||
//                                                 updated_instructor_data?.user[
//                                                     key
//                                                 ]
//                                         ).equals(value);
//                                     }
...
//                                 original_instructor_data.user.id.toString(),
//                                 'Check ID passed'
//                             );
//                         },
//                     },
...
//                     `/form/instructor/${original_instructor_data.user.id}`
//                 );
//             }
//         );
//     });
...
//             cy.get('[data-cy=basicInfo-firstName-input]').should(
//                 'have.value',
//                 original_instructor_data.user.firstName
//             );
//             cy.get('[data-cy=basicInfo-address-input]').should(
//                 'have.value',
//                 original_instructor_data.address
//             );
//             cy.get('[data-cy=basicInfo-phoneNumber-input]')
//                 .should(
//                     'have.value',
//                     original_instructor_data.phoneNumber.replace(
//                         /(\d{3})(\d{3})(\d{4})/,
//                         '($1) $2-$3'
//                     )
//                 )
...
//             cy.get('[data-cy=basicInfo-phoneNumber-input]').fastType(
//                 updated_instructor_data.phoneNumber
//             );
...
//             cy.get('[data-cy=experience-experience-input]').should(
//                 'have.value',
//                 original_instructor_data.experience
//             );
//             cy.get('[data-cy=experience-biography-input]').should(
//                 'have.value',
//                 original_instructor_data.biography
//             );
//             cy.get('[data-cy=experience-language-input]').should(
//                 'have.value',
//                 original_instructor_data.language
//             );
//             cy.get('[data-cy=nextButton]').should('be.enabled');
//         });
//     });
...
//         cy.fixture('users.json').then(({ updated_instructor_data }) => {
//             cy.get('[data-cy=backButton]').should('be.enabled').click();
//             cy.get('[data-cy=basicInfo-phoneNumber-input]').should(
//                 'have.value',
//                 updated_instructor_data.phoneNumber.replace(
//                     /(\d{3})(\d{3})(\d{4})/,
//                     '($1) $2-$3'
//                 )
//             );
//             cy.get('[data-cy=nextButton]').should('be.enabled').click();
//         });
//     });
...
//             cy.get('[data-cy=experience-experience-input').should(
//                 'have.value',
//                 updated_instructor_data.experience
//             );
//             cy.get('[data-cy=experience-biography-input').should(
//                 'have.value',
//                 updated_instructor_data.biography
//             );
//             cy.get('[data-cy=experience-language-input').should(
//                 'have.value',
//                 updated_instructor_data.language
//             );
//         });
//     });
