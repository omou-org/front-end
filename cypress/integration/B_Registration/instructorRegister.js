describe("Fills out form", () => {
    ...
    it("Fills out login and user information", () => {
        cy.get("[data-cy=basicInfo-email-input]")
            .fastType("casey@jones.com");
        cy.get("[data-cy=basicInfo-firstName-input]")
            .fastType("Casey");
        cy.get("[data-cy=basicInfo-lastName-input]")
            .fastType("Jones");
        cy.get("[data-cy=basicInfo-gender-select]").click();
        cy.get("[data-value=UNSPECIFIED]").click();
        cy.get("[data-cy=basicInfo-address-input]").fastType("1273 main street");
