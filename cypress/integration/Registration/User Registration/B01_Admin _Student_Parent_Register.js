describe('Fills out form', () => {
    ...
    it('Fills out required student fields', () => {
        cy.fixture('users.json').then(({ student }) => {
            cy.get('[data-cy=student-first_name-input]').fastType(
                student.first_name
            );
            cy.get('[data-cy=student-last_name-input]').fastType(
                student.last_name
            );
    ...
    it('Fills out optional student fields', () => {
        cy.fixture('users.json').then(({ student }) => {
            ...
            cy.get('[data-cy=student-birthday-input]').fastType(
                student.birth_date
            );
            cy.get('[data-cy=student-school-input]').fastType(student.school);
            cy.get('[data-cy=student-phone_number-input').fastType(
    ...
    it('Fills out required parent fields', () => {
        cy.fixture('users.json').then(({ parent }) => {
            cy.get('[data-cy=parent-first_name-input]').fastType(
                parent.first_name
            );
            cy.get('[data-cy=parent-last_name-input]').fastType(
                parent.last_name
            );
            ...
            cy.get('[data-cy=parent-phone_number-input]').fastType(
                parent.phone_number
            );
    ...
    it('Fills out optional parent fields', () => {
        cy.fixture('users.json').then(({ parent }) => {
            ...
            cy.get('[data-cy=parent-birthday-input]').fastType(
                parent.birth_date
            );
