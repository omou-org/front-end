                    ...
                    <Grid container>
                        ...
                        <Grid item>
                            <Grid container direction='column'>
                                ...
                                <Grid item>
                                    <ColorBox bgcolor={theme.colors.omouBlue} />
                                    <Typography>Omou Blue</Typography>
                                    <Typography>
                                        {theme.colors.omouBlue}
                                    </Typography>
                                </Grid>
                                <Grid item>
                                    <ColorBox bgcolor={theme.colors.skyBlue} />
                                ...
                                <Grid item>
                                    <ColorBox bgcolor={theme.colors.white} />
                        ...
                        <Grid item>
                            <Grid container direction='column'>
                                ...
                                <Grid item>
                                    <ColorBox bgcolor={theme.colors.charcoal} />
                                ...
                                <Grid item>
                                    <ColorBox bgcolor={theme.colors.gloom} />
                                ...
                                <Grid item>
                                    <ColorBox bgcolor={theme.colors.cloudy} />
