...
const LoginPage = () => {
    const fetchUserStatus =
        useSelector(({RequestStatus}) => RequestStatus.userFetch);
    ...
    return (
        <Paper className="bg">
            ...
            <form onSubmit={handleSubmit}>
                <TextField className="email" error={failedLogin || email === ""}
                    inputProps={{"data-cy": "emailField"}} label="E-Mail"
                    margin="dense" onChange={handleTextInput(setEmail)}
                    value={email} />
                <TextField autoComplete="current-password" className="password"
                    error={failedLogin || password === ""}
                    inputProps={{"data-cy": "passwordField"}} label="Password"
                    margin="normal" onChange={handleTextInput(setPassword)}
                    type="password" value={password} />
                <Grid container>
                    <Grid className="remember" item>
                        <Checkbox checked={savePassword} component="label"
                            inputProps={{
                                "data-cy": "rememberMe",
                ...
                <Button className="signIn" color="primary"
