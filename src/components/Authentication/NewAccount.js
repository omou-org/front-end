...
const basicInfo = [
    <Fields.TextField className="TextField" fullWidth={false} key="firstName" label="First Name" margin="dense"
                      name="firstName" required variant="outlined"/>,
    <Fields.TextField className="TextField" fullWidth={false} key="lastName" label="Last Name" margin="dense"
                      name="lastName" required variant="outlined"/>,
    <Fields.TextField className="TextField" fullWidth={false} key="email" label="Email" margin="dense" name="email"
                      required type="email" variant="outlined"/>,
    <Fields.PasswordInput className="TextField" fullWidth={false} key="password" margin="dense" name="password" required
                          variant="outlined"/>,
    <Fields.TextField className="TextField" fullWidth={false} key="phone" label="Phone Number" margin="dense" name="phoneNumber" variant="outlined" />,
    ...
    const renderNoForm = () => (
        <>
            ...
            <ToggleButtonGroup
                ...
                value={type}>
                <ToggleButton aria-label="parent" className="btn" value="parent" >
                    Parent
                </ToggleButton>
                <ToggleButton aria-label="student" className="btn" value="student" >
                    Student
                </ToggleButton>
            </ToggleButtonGroup>
            {type === "student" && (
                <Typography className="iam" style={{
                    "width": "75%",
                    "margin": "auto",
                }} variant="body1">
                    For students, you will receive an email to create an account when a parent adds you to their profile.
                </Typography>
            )}
        </>
    );
