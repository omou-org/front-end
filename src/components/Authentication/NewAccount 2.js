...
const basicInfo = [
    ...
    <Fields.TextField className="TextField" fullWidth={false} key="lastName" label="Last Name" margin="dense" name="lastName" required variant="outlined" />,
    <Fields.TextField className="TextField" fullWidth={false} key="email" label="Email" margin="dense" name="email" required type="email" variant="outlined" />,
    <Fields.PasswordInput className="TextField" fullWidth={false} key="password" margin="dense" name="password" required variant="outlined" />,
