...
class TimeSelector extends Component {
    ...
    setTimeframe() {
        ...
        let availableDates = [],
            ...
            sessionDurationDays = Date.daysBetween(startDate, endDate);
        ...
        availableDates = availableDates.map((date) => {
            currentDateCourses = currentInstructorCourses.filter(
                (course) => {}
            );
        });
        ...
        return (
            <div>
                ...
                <Select
                    ...
                    onChange={(e) => {
                        e.preventDefault();
                        this.setState({ sessionNum: e.target.value });
                    }}
                >
                    {selectOptions.map((sessionNum) => {
                        return (
                            <MenuItem value={sessionNum}>{sessionNum}</MenuItem>
                        );
                    })}
                </Select>
            ...
            <Grid container className='TimeSelector'>
                <form>
                        ...
                        : ''}
                    {
                        ...
                        this.state.sessionNum !== -1 &&
                        this.state.daysOfWeek.find((day) => {
                            return day.value;
                        })
