...
const ProfileHeading = ({ user }) => {
  ...
  //         resetPassword(newPassword: $password, token: $token, setInstructor: $isInstructor, setStudent: $isParent) {
  //             status
  //         }
  // 	}`;
          ...
          <Grid component={Hidden} item mdDown xs={12}>
            ...
            <div className="editResetDiv">
              ...
              {user.role === "student" ? (
                ...
                <Button className="reset" onClick={handleClickOpen}>
                  Reset Password
                </Button>
              )}
            </div>
    ...
    <>
      ...
      >
        ...
        <DialogActions className="dialog-actions">
          <Button onClick={handleClosePassword} variant="outlined" className="cancelBtn">
            cancel
          </Button>
          <Button
