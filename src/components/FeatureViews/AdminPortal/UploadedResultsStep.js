...
const UploadedResultsStep = ({
    ...
    const totalSuccess =
        uploadedResponse?.data[`upload${selectedItem}`].totalSuccess;
    const totalFailure =
        uploadedResponse?.data[`upload${selectedItem}`].totalFailure;
            ...
            <Grid item style={{ padding: '2em' }} xs={12}>
                ...
                {uploadedResponse?.data[`upload${selectedItem}`].errorExcel !==
                    ...
                    <div style={{ margin: '1em 0px' }}>
                        ...
                        <IconButton onClick={handleDownloadErrorFile}>
                            <SvgIcon>
                                <path
