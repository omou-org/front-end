...
const ManageCategories = () => {
    ...
    const categories = useSelector(({"Course": {CourseCategories}}) =>
        CourseCategories);
    ...
    const editCategory = (id) => () => {
        const editingCategory = categoryList.find((category) =>
            category.id === id);
        if (editingCategory) {
    ...
    const handleEditCategory = (type, id) => ({target}) => {
        const editingCategory = categoryList
