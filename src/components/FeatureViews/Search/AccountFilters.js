...
const AccountFilters = () => {
	...
	return (
		<Grid alignItems="center" container direction="row" item spacing={16}>
			<Grid item>
			...
			<Grid item>
				<FormControl className="search-filter-wrapper">
					<Select
						input={<BootstrapInput id="filter-student" name="profileType"/>}
			...
			<Grid item>
				<FormControl className="search-filter-wrapper">
					<Select
						...
						input={<BootstrapInput id="filter-grade" name="gradeFilter"/>}
						onChange={handleFilterChange}
			...
			<Grid item>
				<FormControl className="search-filter-wrapper">
					<Select
						input={<BootstrapInput id="filter-sort" name="sortFilter"/>}
						onChange={handleFilterChange}
