...
function RegistrationEntry({
    registration: { course, numSessions, checked },
    studentId,
    index,
}) {
            ...
            <TableRow>
                ...
                <TableCell style={{ maxWidth: 750 }}>
                    <Grid container>
                        <Grid>
                            <Typography
                                style={{ fontWeight: 600, paddingRight: 50 }}
                            >
                    ...
                    <Grid container>
                        ...
                        >
                            ...
                            {sessionsAtSameTimeInMultiDayCourse(
                                ...
                                ? ', ' +
                                  course.availabilityList[0].startTime.slice(
                                      0,
                                      5
                                  ) +
                                  ' - ' +
                ...
                >
                    {parentIsLoggedIn ? (
                        <Typography>{totalCourseSessions}</Typography>
                    ) : (
                        <TextField
                ...
                >
                    ...
                    {getTuitionAmount(
                        course,
                        parentIsLoggedIn ? totalCourseSessions : numSessions
                    )}
                </TableCell>
            </TableRow>
        </>
...
function StudentRegistrationEntry({
                                      student,
                                      registrationList,
                                  }) {
    return (
