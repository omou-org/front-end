...
const Payment = ({isOneCourse, selectedStudentID, selectedCourseID,
                ...
                if (courseVal.checked) {
                    ...
                    if (courseID.indexOf("T") > -1) {
                        ...
                        courses.tutoring.push({
                            "academic_level":
                                academic_level || new_course.academic_level,
                            "category_id": category || new_course.category,
                            "courseID": course.course_id,
                            "duration": durationParser[
                                form.Schedule && form.Schedule.Duration
                            ],
                            new_course,
    ...
    return (
        <Grid container spacing={8}>
                    ...
                    <Grid item>
                        <Grid container justify="flex-end">
                            {!selectedCourseSameAsRedux() &&
                                <Button className="button" disabled={!allValid}
            ...
            <Grid item xs={12}>
                <PriceQuoteForm courses={registeredCourses().courses}
                    disablePay={!(selectedCoursesHaveSession() &&
                        selectedCourseSameAsRedux())}
