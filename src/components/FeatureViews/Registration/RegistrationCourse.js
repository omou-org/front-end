    ...
    <Grid className="registrationCourse" item xs={12}>
      <Paper className="paper content">
        ...
        <div className="course-heading">
          <Typography align="left" style={{ fontWeight: "500" }} variant="h3">
            {course.title}
            {isAdmin && (
              <Button
                className="button"
          ...
          <div className="info-section">
            <div className="first-line">
              <ClassIcon className="icon" style={{ fontSize: "16" }} />
        ...
        >
          ...
          <Tab
            label={
              course.notes &&
              Object.values(course.notes).some(({ important }) => important) ? (
                <>
                  <Avatar
        ...
        {activeTab === 1 && (
          <div style={{ paddingTop: 30 }}>
            <Note ownerID={courseID} ownerType="course" />
          </div>
        )}
      </Paper>
    </Grid>
