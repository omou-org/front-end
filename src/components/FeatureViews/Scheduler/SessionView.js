...
class SessionView extends Component {
    ...
    componentWillMount() {
        ...
        this.setState(() => {
            ...
            const matches = this.props.match.params.course_id
            const sessionMatches = this.props.match.params.session_id

            let sessionData = this.props.courseSessions[matches][sessionMatches]
            let courseData = this.props.courses[matches]
