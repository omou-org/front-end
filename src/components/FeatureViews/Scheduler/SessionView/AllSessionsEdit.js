...
const AllSessionsEdit = () => {
    ...
    const [getCurrentTimeChange, setGetCurrentTimeChange] = useState({});
    ...
    const dayOfWeek = moment(getCurrentTimeChange.startTime).format('dddd');
    const monthAndDate = moment(getCurrentTimeChange.startTime).format('MMMM DD');
    const startSessionTime = moment(getCurrentTimeChange.startTime).format('h:mm A');
    const endSessionTime = moment(getCurrentTimeChange.endTime).format('h:mm A');
    ...
    console.log(courseAvailabilities);
    console.log(getCurrentTimeChange);
                ...
                <Grid item container>
                    {courseAvailabilities.map((availability) => (
                        <EditMultiSessionFields
                            ...
                            key={availability.id}
                            setGetCurrentTimeChange={setGetCurrentTimeChange}
                        />
                    ))}
                </Grid>
